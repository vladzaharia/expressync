      ...
      <div class="min-h-screen flex items-center justify-center bg-background p-4">
        <div class="w-full max-w-md rounded-lg border border-amber-500/40 bg-amber-500/5 p-6 text-sm">
          ...
          <p class="text-muted-foreground">
            This URL is the registration entry point for the iOS ExpressCharge
            app. Tap "Sign in" inside the app to start the flow — it will open
            this page with a one-time PKCE challenge attached and send you
