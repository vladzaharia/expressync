 ...
 * - Cross-subdomain cookies scoped to .example.com so admin
 *   (manage.example.com) and customer (example.com) share session.
 */
export const auth = betterAuth({
  ...
  // Cross-subdomain cookies so manage.example.com and example.com
  // share one session. Cookie Domain attribute is set to .example.com;
