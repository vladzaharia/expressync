 ...
 * `https://mail.example.com`). The worker handles per-recipient rate
 ...
 * at `example.com/login`. NEVER throws — returns a result object.
 */
...
/** Admin password-reset email — admin-only flow from `manage.example.com`. */
