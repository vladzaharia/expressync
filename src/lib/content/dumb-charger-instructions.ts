...
export const DUMB_CHARGER_HEADLINE = "Just plug in and charge";
...
export const DUMB_CHARGER_TAGLINE = "No tap required. No charge to you.";

export const DUMB_CHARGER_SUPPORT_EMAIL = "support@expressync.app";
