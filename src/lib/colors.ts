...
> = {
  red: {
    ...
    toggleOn: "hover:text-red-600 dark:hover:text-red-400 data-[state=on]:bg-red-500/20 data-[state=on]:text-red-600 dark:data-[state=on]:text-red-400",
  },
  orange: {
    bg: "bg-orange-500/20",
    ...
    toggleOn: "hover:text-orange-600 dark:hover:text-orange-400 data-[state=on]:bg-orange-500/20 data-[state=on]:text-orange-600 dark:data-[state=on]:text-orange-400",
  },
  amber: {
    bg: "bg-amber-500/20",
    ...
    toggleOn: "hover:text-amber-600 dark:hover:text-amber-400 data-[state=on]:bg-amber-500/20 data-[state=on]:text-amber-600 dark:data-[state=on]:text-amber-400",
  },
  yellow: {
    bg: "bg-yellow-500/20",
    ...
    toggleOn: "hover:text-yellow-600 dark:hover:text-yellow-400 data-[state=on]:bg-yellow-500/20 data-[state=on]:text-yellow-600 dark:data-[state=on]:text-yellow-400",
  },
  lime: {
    bg: "bg-lime-500/20",
    ...
    toggleOn: "hover:text-lime-600 dark:hover:text-lime-400 data-[state=on]:bg-lime-500/20 data-[state=on]:text-lime-600 dark:data-[state=on]:text-lime-400",
  },
  green: {
    bg: "bg-green-500/20",
    ...
    toggleOn: "hover:text-green-600 dark:hover:text-green-400 data-[state=on]:bg-green-500/20 data-[state=on]:text-green-600 dark:data-[state=on]:text-green-400",
  },
  emerald: {
    ...
    toggleOn: "hover:text-emerald-600 dark:hover:text-emerald-400 data-[state=on]:bg-emerald-500/20 data-[state=on]:text-emerald-600 dark:data-[state=on]:text-emerald-400",
  },
  teal: {
    bg: "bg-teal-500/20",
    ...
    toggleOn: "hover:text-teal-600 dark:hover:text-teal-400 data-[state=on]:bg-teal-500/20 data-[state=on]:text-teal-600 dark:data-[state=on]:text-teal-400",
  },
  cyan: {
    bg: "bg-cyan-500/20",
    ...
    toggleOn: "hover:text-cyan-600 dark:hover:text-cyan-400 data-[state=on]:bg-cyan-500/20 data-[state=on]:text-cyan-600 dark:data-[state=on]:text-cyan-400",
  },
  sky: {
    bg: "bg-sky-500/20",
    ...
    toggleOn: "hover:text-sky-600 dark:hover:text-sky-400 data-[state=on]:bg-sky-500/20 data-[state=on]:text-sky-600 dark:data-[state=on]:text-sky-400",
  },
  blue: {
    bg: "bg-blue-500/20",
    ...
    toggleOn: "hover:text-blue-600 dark:hover:text-blue-400 data-[state=on]:bg-blue-500/20 data-[state=on]:text-blue-600 dark:data-[state=on]:text-blue-400",
  },
  indigo: {
    bg: "bg-indigo-500/20",
    ...
    toggleOn: "hover:text-indigo-600 dark:hover:text-indigo-400 data-[state=on]:bg-indigo-500/20 data-[state=on]:text-indigo-600 dark:data-[state=on]:text-indigo-400",
  },
  violet: {
    bg: "bg-violet-500/20",
    ...
    toggleOn: "hover:text-violet-600 dark:hover:text-violet-400 data-[state=on]:bg-violet-500/20 data-[state=on]:text-violet-600 dark:data-[state=on]:text-violet-400",
  },
  purple: {
    bg: "bg-purple-500/20",
    ...
    toggleOn: "hover:text-purple-600 dark:hover:text-purple-400 data-[state=on]:bg-purple-500/20 data-[state=on]:text-purple-600 dark:data-[state=on]:text-purple-400",
  },
  fuchsia: {
    ...
    toggleOn: "hover:text-fuchsia-600 dark:hover:text-fuchsia-400 data-[state=on]:bg-fuchsia-500/20 data-[state=on]:text-fuchsia-600 dark:data-[state=on]:text-fuchsia-400",
  },
  pink: {
    bg: "bg-pink-500/20",
    ...
    toggleOn: "hover:text-pink-600 dark:hover:text-pink-400 data-[state=on]:bg-pink-500/20 data-[state=on]:text-pink-600 dark:data-[state=on]:text-pink-400",
  },
  rose: {
    bg: "bg-rose-500/20",
    ...
    toggleOn: "hover:text-rose-600 dark:hover:text-rose-400 data-[state=on]:bg-rose-500/20 data-[state=on]:text-rose-600 dark:data-[state=on]:text-rose-400",
  },
  slate: {
    bg: "bg-slate-500/20",
    ...
    toggleOn: "hover:text-slate-600 dark:hover:text-slate-400 data-[state=on]:bg-slate-500/20 data-[state=on]:text-slate-600 dark:data-[state=on]:text-slate-400",
  },
};
