...
const RULES: readonly RouteRule[] = [
  ...
  { prefix: "/favicon.svg", classification: "PUBLIC" },
  ...
  { prefix: "/favicon-96.png", classification: "PUBLIC" },
  { prefix: "/icon-192.png", classification: "PUBLIC" },
  { prefix: "/icon-512.png", classification: "PUBLIC" },
  { prefix: "/icon-maskable-192.png", classification: "PUBLIC" },
  { prefix: "/icon-maskable-512.png", classification: "PUBLIC" },
