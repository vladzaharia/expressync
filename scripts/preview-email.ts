    ...
    case "magic-link":
      return renderTemplate(
        buildMagicLinkEmail({
          ...
          url: "https://example.com/auth/verify?token=preview-token-xyz",
        }),
      );
    ...
    case "admin-password-reset":
      return renderTemplate(
        buildAdminPasswordResetEmail({
          to: "ops@example.com",
          url: "https://manage.example.com/reset-password?token=preview",
        }),
      );
  }
}
  ...
  switch (name) {
    case "magic-link":
      await sendCustomerMagicLink(
        to,
        "https://example.com/auth/verify?token=smoke-test-token",
      );
      return;
    case "session-summary":
    ...
    case "admin-password-reset":
      await sendAdminPasswordReset(
        to,
        "https://manage.example.com/reset-password?token=smoke",
      );
      return;
  }
}
